...
const Footer = () => {
  return (
    <footer className="bg-secondary_color mt-auto text-background font-Cinzel_Decorative py-10 bottom-0">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center border-b-2 border-background pb-8">
          <div className="flex flex-col items-center md:items-start mb-6 md:mb-0">
            ...
            <div className="flex w-fit bg-white ">
              <input
                ...
                className="px-[2px] md:px-4 py-2 text-lg bg-white "
              />
              <button className="bg-background text-black px-[2px] md:px-4 py-2 text-lg ml-2">
                Subscribe
              </button>
            </div>
          </div>
          <div className="flex space-x-4">
            ...
            <Link
              ...
              rel="noreferrer"
            >
              <BsTwitterX className="h-8 w-8 hover:text-gray-700 transition duration-300" />
            </Link>
            <Link
